...
function Buttons({ onUndo, onNewGame }: ButtonProps) {
  return (
    <div className="flex justify-end my-3">
      <button
        className="bg-rose-300 p-2 px-2 rounded-md hover:bg-rose-400"
        onClick={onUndo}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          className="w-6 h-6 inline-block fill-rose-100"
        >
      ...
      <button
        className="bg-rose-300 p-2 px-2 ml-2 rounded-md hover:bg-rose-400"
        onClick={onNewGame}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
