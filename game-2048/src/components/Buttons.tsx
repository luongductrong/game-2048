...
function Buttons({ onUndo, onNewGame }: ButtonProps) {
  return (
    <div className="flex justify-end my-2">
      <button
        className="bg-rose-300 pb-1 px-2 ml-2 rounded-md hover:bg-rose-400"
        onClick={onUndo}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          className="w-4 h-4 inline-block fill-rose-50 font-black"
        >
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          className="w-4 h-4 inline-block fill-rose-50"
        >
